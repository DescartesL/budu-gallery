<template>
  <div class="carousel">
    <div v-for="item in months" :key="item" @dblclick="choiceMonth(item.title)" class="carousel-item">
      ...
      months: [
        {
          title: 'January',
          num: '01',
          img: '/src/assets/images/calendar/January.png'
        },
        {
          title: 'February',
          num: '02',
          img: '/src/assets/images/calendar/February.png'
        },
        {
          title: 'March',
          num: '03',
          img: '/src/assets/images/calendar/March.png'
        },
        {
          title: 'April',
          num: '04',
          img: '/src/assets/images/calendar/April.png'
        },
        {
          title: 'May',
          num: '05',
          img: '/src/assets/images/calendar/May.png'
        },
        {
          title: 'June',
          num: '06',
          img: '/src/assets/images/calendar/June.png'
        },
        {
          title: 'July',
          num: '07',
          img: '/src/assets/images/calendar/July.png'
        },
        {
          title: 'August',
          num: '08',
          img: '/src/assets/images/calendar/August.png'
        },
        {
          title: 'September',
          num: '09',
          img: '/src/assets/images/calendar/September.png'
        },
        {
          title: 'October',
          num: '10',
          img: '/src/assets/images/calendar/October.png'
        },
        {
          title: 'November',
          num: '11',
          img: '/src/assets/images/calendar/November.png'
        },
        {
          title: 'December',
          num: '12',
          img: '/src/assets/images/calendar/December.png'
        },
