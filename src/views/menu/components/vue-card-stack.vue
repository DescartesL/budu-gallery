<template>
    <div class="vue-card-stack__wrapper">
        <div class="vue-card-stack__stack" :style="{
            height: `${cardHeight + paddingVertical * 2}px`,
            width: containerWidth,
        }">
            <div class="vue-card-stack__card" v-for="(card, index) in stack" :key="card._id" :style="{
                ...
                zIndex: card.zIndex,
                transition: `transform ${isDragging ? 0 : speed
